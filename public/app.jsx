...
// ── PUZZLE SCREEN ──────────────────────────────────────────────────────────
function PuzzleScreen({onComplete,hardMode,day,c}){
  ...
  function handleSubmit(timedOut=false){
    ...
    setTimeout(()=>{if(isLast) onComplete(newScores.reduce((a,b)=>a+b.pts,0),newScores); else setQIdx(i=>i+1);},1400);
  }
...
window.TriviaApp = function App(){
  ...
  function handlePuzzleComplete(score,bd){
  ...
  return(
    ...
    <>
      ...
      {user&&<div style={{maxWidth:430,margin:"0 auto",paddingBottom:showNav?64:0,minHeight:"100vh",background:c.bg}}>
        ...
        {screen==="puzzle"      &&<ErrorBoundary><PuzzleScreen onComplete={handlePuzzleComplete} hardMode={currentMode} day={day} c={c}/></ErrorBoundary>}
