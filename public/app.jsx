      ...
      <div style={{padding:"20px 20px 0"}}>
        ...
        {(q.type==="multiple_choice"||q.type==="timed")&&(
          <div style={{display:"flex",flexDirection:"column",gap:10}}>
            {q.options.map(opt=>{
              const isSel=selected===opt,isCorr=submitted&&opt===displayAnswer,isWrong=submitted&&isSel&&opt!==displayAnswer;
              return (
        ...
        {q.type==="type_in"&&(
          <div>
            ...
            {submitted&&displayAnswer&&<div style={{marginTop:8,fontSize:14,color:c.textMuted}}>Accepted answer: <strong style={{color:c.correct}}>{displayAnswer}</strong></div>}
          </div>
        )}
